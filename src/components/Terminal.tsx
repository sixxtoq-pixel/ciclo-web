...
type UserDoc = { cursor?: number; subtitle?: string };
...
export default function Terminal() {
  ...
  return (
    /* Overlay que ocupa todo y centra el panel */
    <div className="fixed inset-0 grid place-items-center">
      <div className="crt crt-flicker w-[min(95vw,860px)] border border-green-900/40 p-8 md:p-10 rounded-xl bg-[#00140F]/80 shadow-[0_0_60px_rgba(0,255,170,.12)_inset] font-mono">
